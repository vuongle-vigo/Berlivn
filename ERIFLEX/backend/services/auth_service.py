...
def register_user(user_data: Dict[str, Any]) -> Dict[str, Any]:
	"""
	Tạo user mới. user_data chứa email, password và các trường profile bắt buộc.
	Ném ValueError nếu email tồn tại.
	"""
	print(user_data)
	init_user_table()
...
def authenticate_user(email: str, password: str) -> Optional[Dict[str, Any]]:
	...
	init_user_table()
	# Sử dụng get_user_by_email để lấy đầy đủ thông tin
